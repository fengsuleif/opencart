		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'shipping_zone_code'      => $shipping_zone_code,
					'shipping_sfza'      => $order_query->row['shipping_sfza'],
					'shipping_sfzb'      =>$order_query->row['shipping_sfzb'],
					'payment_sfza'      => $order_query->row['payment_sfza'],
					'payment_sfzb'      =>$order_query->row['payment_sfzb'],
