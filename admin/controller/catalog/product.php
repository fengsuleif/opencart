...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_target_group'] = $this->language->get('entry_target_group');
		$this->data['entry_usage'] = $this->language->get('entry_usage');
		$this->data['entry_photo'] = $this->language->get('entry_photo');
		$this->data['entry_attention'] = $this->language->get('entry_attention');
		...
		//单品包邮
		if (isset($this->request->post['baoyou'])) {
			$this->data['baoyou'] = $this->request->post['baoyou'];
		} elseif (!empty($product_info)) {
			$this->data['baoyou'] = $product_info['baoyou'];
		} else {
			$this->data['baoyou'] = '';
		}
		
		//精品特卖
		if (isset($this->request->post['jingpin'])) {
			$this->data['jingpin'] = $this->request->post['jingpin'];
		} elseif (!empty($product_info)) {
			$this->data['jingpin'] = $product_info['jingpin'];
		} else {
			$this->data['jingpin'] = '';
		}
		
		//销量NO.1
		if (isset($this->request->post['xiaoliang'])) {
			$this->data['xiaoliang'] = $this->request->post['xiaoliang'];
		} elseif (!empty($product_info)) {
			$this->data['xiaoliang'] = $product_info['xiaoliang'];
		} else {
			$this->data['xiaoliang'] = '';
		}
		...
		//送
		if (isset($this->request->post['song'])) {
			$this->data['song'] = $this->request->post['song'];
		} elseif (!empty($product_info)) {
			$this->data['song'] = $product_info['song'];
		} else {
			$this->data['song'] = '';
		}
		...
		//德国制造
		if (isset($this->request->post['deguo'])) {
			$this->data['deguo'] = $this->request->post['deguo'];
		} elseif (!empty($product_info)) {
			$this->data['deguo'] = $product_info['deguo'];
		} else {
			$this->data['deguo'] = '';
		}
		
		//功效
		if (isset($this->request->post['gongxiao'])) {
			$this->data['gongxiao'] = $this->request->post['gongxiao'];
		} elseif (!empty($product_info)) {
			$this->data['gongxiao'] = $product_info['gongxiao'];
		} else {
			$this->data['gongxiao'] = '';
		}
		
		//产品容量
		if (isset($this->request->post['rongliang'])) {
			$this->data['rongliang'] = $this->request->post['rongliang'];
		} elseif (!empty($product_info)) {
			$this->data['rongliang'] = $product_info['rongliang'];
		} else {
			$this->data['rongliang'] = '';
		}
		
		//产品包装
		if (isset($this->request->post['baozhuang'])) {
			$this->data['baozhuang'] = $this->request->post['baozhuang'];
		} elseif (!empty($product_info)) {
			$this->data['baozhuang'] = $product_info['baozhuang'];
		} else {
			$this->data['baozhuang'] = '';
		}
		
		//原产国家
		if (isset($this->request->post['yuanchan'])) {
			$this->data['yuanchan'] = $this->request->post['yuanchan'];
		} elseif (!empty($product_info)) {
			$this->data['yuanchan'] = $product_info['yuanchan'];
		} else {
			$this->data['yuanchan'] = '';
		}
		
		//保质期限
		if (isset($this->request->post['baozhi'])) {
			$this->data['baozhi'] = $this->request->post['baozhi'];
		} elseif (!empty($product_info)) {
			$this->data['baozhi'] = $product_info['baozhi'];
		} else {
			$this->data['baozhi'] = '';
		}
