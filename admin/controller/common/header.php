...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_wpcms'] = $this->language->get('text_wpcms');
		$this->data['text_wppost'] = $this->language->get('text_wppost');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['wpcms'] = $this->url->link('catalog/wpcms', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['wppost'] = $this->url->link('catalog/wppost', 'token=' . $this->session->data['token'], 'SSL');
