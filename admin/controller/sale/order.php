...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (isset($this->request->post['shipping_sfza'])) {
			$this->data['shipping_sfza'] = $this->request->post['shipping_sfza'];
		} elseif (!empty($order_info)) {
			$this->data['shipping_sfza'] = $order_info['shipping_sfza'];
		} else {
			$this->data['shipping_sfza'] = '';
		}
		
		
		if (isset($this->request->post['shipping_sfzb'])) {
			$this->data['shipping_sfzb'] = $this->request->post['shipping_sfzb'];
		} elseif (!empty($order_info)) {
			$this->data['shipping_sfzb'] = $order_info['shipping_sfzb'];
		} else {
			$this->data['shipping_sfzb'] = '';
		}
		if (isset($this->request->post['payment_sfza'])) {
			$this->data['payment_sfza'] = $this->request->post['payment_sfza'];
		} elseif (!empty($order_info)) {
			$this->data['payment_sfza'] = $order_info['payment_sfza'];
		} else {
			$this->data['payment_sfza'] = '';
		}
		
		
		if (isset($this->request->post['payment_sfzb'])) {
			$this->data['payment_sfzb'] = $this->request->post['payment_sfzb'];
		} elseif (!empty($order_info)) {
			$this->data['payment_sfzb'] = $order_info['payment_sfzb'];
		} else {
			$this->data['payment_sfzb'] = '';
		}
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['payment_address_1']) < 2) || (utf8_strlen($this->request->post['payment_address_1']) > 128)) {
		...
		if ($shipping) {
			...
			if ((utf8_strlen($this->request->post['shipping_address_1']) < 2) || (utf8_strlen($this->request->post['shipping_address_1']) > 128)) {
