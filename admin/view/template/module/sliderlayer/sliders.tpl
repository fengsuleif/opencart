  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons pull-right">
                ...
                <a onclick="$('#action_mode').val('module-only');$('#form').submit();" class="button grey"><?php echo $this->language->get('Save Modules Only'); ?></a>
    ...
    <div class="page-content">
     ...
     <div id="tab-slidergroups">
        ...
        <div class="groups">
                <h4><?php echo $this->language->get('Slider Groups Management');?></h4>
                <ul>
        ...
        <div class="group-form">
            ...
            <table class="form">
                <tr>
                    ...
                    <td>
                        ...
                        <div class="buttons">
                            ...
                            <a href="<?php echo  $this->url->link('module/pavsliderlayer/layer', 'group_id='.$id.'&token=' . $this->session->data['token'], 'SSL');?>" class="btn btn-green" id="preview-sliders">
                             <?php echo $this->language->get('Manages Sliders'); ?>
                             </a>
                            ...
                            <a href="<?php echo  $this->url->link('module/pavsliderlayer/delete', 'id='.$id.'&token=' . $this->session->data['token'], 'SSL');?>" onclick="return confirm('Are you sure to delete this');" class="btn " id="preview-sliders">
                                <?php echo $this->language->get('Delete'); ?>
                            </a>
                ...
                <tr>
                <tr>
                    <td><?php echo $this->language->get('Slide Group entry_title');?></th>
