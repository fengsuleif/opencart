...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a></div>
        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                <td><?php echo $entry_target_group; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id'];?>][goup]"  rows="6" cols="10"><?php echo $product_description[$language['language_id']]['goup'];?></textarea></td>
              </tr>
              
               <tr>
                <td><?php echo $entry_usage; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id'];?>][fa]"  rows="6" cols="10"><?php echo $product_description[$language['language_id']]['fa'];?></textarea></td>
              </tr>
               <tr>
                <td><?php echo $entry_photo; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id'];?>][photo]"  rows="6" cols="10"><?php echo $product_description[$language['language_id']]['photo'];?></textarea></td>
              </tr>
               <tr>
                <td><?php echo $entry_attention; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id'];?>][attention]"  rows="6" cols="10"><?php echo $product_description[$language['language_id']]['attention'];?></textarea></td>
              </tr>
          ...
          <table class="form">
           ...
           <tr>
            ...
            <tr>
              ...
              <td>
                <?php if ($baoyou) { ?>
                <input type="radio" name="baoyou" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                ...
                <?php echo $text_yes; ?>
                <input type="radio" name="baoyou" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?>
            ...
            <tr>
              ...
              <td>
                <?php if ($jingpin) { ?>
                <input type="radio" name="jingpin" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="jingpin" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="jingpin" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="jingpin" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?>
               </td>
            </tr>
            <tr>
              ...
              <td>
              <?php if ($deguo) { ?>
                <input type="radio" name="deguo" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="deguo" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="deguo" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="deguo" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?>
               </td>
            </tr>
              ...
              <td>
              <?php if ($song) { ?>
                <input type="radio" name="xiaoliang" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="xiaoliang" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="xiaoliang" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="xiaoliang" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?>
               </td>
            </tr>
            ...
            <select name="song">
                 ...
                 <option>请选择</option>
                  ...
                  <?php if ($song == 1) { ?>
                  <option value="1" selected="selected">爸妈</option>
                  <?php } else { ?>
                  <option value="1">爸妈</option>
                  <?php } ?>
                    <?php if ($song == 2) { ?>
                  <option value="2" selected="selected">老婆</option>
                  <?php } else { ?>
                  <option value="2">老婆</option>
                  <?php } ?>
                    <?php if ($song == 3) { ?>
                  <option value="3" selected="selected">老公</option>
                  <?php } else { ?>
                  <option value="3">老公</option>
                  <?php } ?>
            ...
            <tr>
             ...
             <tr>
              <td>功效</td>
              <td><input type="text" name="gongxiao" value="<?php echo $gongxiao; ?>" /></td>
            </tr>
            
            <tr>
              <td>产品容量</td>
             <td><input type="text" name="rongliang" value="<?php echo $rongliang; ?>" /></td>
            </tr>
            
            <tr>
              <td>产品包装</td>
              <td><input type="text" name="baozhuang" value="<?php echo $baozhuang; ?>" /></td>
            </tr>
            
            <tr>
              <td>原产国家</td>
              <td><input type="text" name="yuanchan" value="<?php echo $yuanchan; ?>" /></td>
            </tr>
            
            <tr>
              <td>保质期限</td>
              <td><input type="text" name="baozhi" value="<?php echo $baozhi; ?>" /></td>
            </tr>
...
<?php } ?>
  ...
  <?php foreach ($languages as $language) { ?>
CKEDITOR.replace('product_description[<?php echo $language['language_id']; ?>][goup]', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
<?php } ?>
  ...
  <?php foreach ($languages as $language) { ?>
CKEDITOR.replace('product_description[<?php echo $language['language_id']; ?>][fa]', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
<?php } ?>
  <?php foreach ($languages as $language) { ?>
CKEDITOR.replace('product_description[<?php echo $language['language_id']; ?>][photo]', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
<?php } ?>
  <?php foreach ($languages as $language) { ?>
CKEDITOR.replace('product_description[<?php echo $language['language_id']; ?>][attention]', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
