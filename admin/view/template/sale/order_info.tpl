        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><?php echo $payment_method; ?></td>
              ...
              <td><span class="required">*</span> 身份证(正面)</td>
              <td> <a href="/image/sfz/<?php echo $payment_sfza; ?>" target="_blank" title="点击预览">  <img src=" /image/sfz/<?php echo $payment_sfza; ?>" width="100px" ></a> </td>
            </tr>
            
              <tr>
              <td><span class="required">*</span> 身份证(背面)</td>
              <td> <a href="/image/sfz/<?php echo $payment_sfzb; ?>" target="_blank" title="点击预览">  <img src=" /image/sfz/<?php echo $payment_sfzb; ?>" width="100px" ></a> </td>
            </tr>
        </table>
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><?php echo $shipping_method; ?></td>
              ...
              <tr>
              <td><span class="required">*</span> 身份证(正面)</td>
              <td> <a href="/image/sfz/<?php echo $shipping_sfza; ?>" target="_blank" title="点击预览">  <img src=" /image/sfz/<?php echo $shipping_sfza; ?>" width="100px" ></a> </td>
            </tr>
            
              <tr>
              <td><span class="required">*</span> 身份证(背面)</td>
              <td> <a href="/image/sfz/<?php echo $shipping_sfzb; ?>" target="_blank" title="点击预览">  <img src=" /image/sfz/<?php echo $shipping_sfzb; ?>" width="100px" ></a> </td>
            </tr>
