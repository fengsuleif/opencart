...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$this->data['goup'] =  html_entity_decode($product_info['goup'], ENT_QUOTES, 'UTF-8');
			$this->data['fa'] =   html_entity_decode($product_info['fa'], ENT_QUOTES, 'UTF-8');
			$this->data['photo'] =   html_entity_decode($product_info['photo'], ENT_QUOTES, 'UTF-8');
			$this->data['attention'] =   html_entity_decode($product_info['attention'], ENT_QUOTES, 'UTF-8');
