		...
		if ($query->num_rows) {
			return array(
				...
				'viewed'           => $query->row['viewed'],
					'new'              => $query->row['new'],
					'baoyou'              => $query->row['baoyou'],
					'jingpin'              => $query->row['jingpin'],
					'deguo'              => $query->row['deguo'],
					'xiaoliang'              => $query->row['xiaoliang'],
					'song'              => $query->row['song'],
					'gongxiao'              => $query->row['gongxiao'],
					'rongliang'              => $query->row['rongliang'],
					'baozhuang'              => $query->row['baozhuang'],
					'yuanchan'              => $query->row['yuanchan'],
					'baozhi'              => $query->row['baozhi'],
					'goup'              => $query->row['goup'],
					'fa'              => $query->row['fa'],
					'photo'              => $query->row['photo'],
					'attention'              => $query->row['attention'],
			);
		} else {
			return false;
		}
